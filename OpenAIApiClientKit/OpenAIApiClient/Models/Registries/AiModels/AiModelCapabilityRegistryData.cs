// <copyright file="AiModelCapabilityRegistryData.cs" company="854 Things (tm)">
...
namespace OpenAIApiClient.Models.Registries.AiModels
{
    ...
    /// </summary>
    public sealed class AiModelCapabilityRegistryData
    {
        /// <summary>
        /// Gets the list of models and their capabilities.
        /// </summary>
        public IList<AiModelCapabilityRegistryModel> Models
        {
            get;
            init;
        } = [];
