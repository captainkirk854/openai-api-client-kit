...
namespace OpenAIApiClient.Orchestration.Factories
{
    ...
    public static class ExecutorFactory
    {
        ...
        /// <returns see cref="(SingleAiModelExecutor, EnsembleExecutor)">A tuple containing the created SingleModelExecutor and EnsembleExecutor instances.</returns>
        public static (SingleAiModelExecutor, EnsembleExecutor) Create(ChatClient client)
        {
            SingleAiModelExecutor single = new(client: client);
